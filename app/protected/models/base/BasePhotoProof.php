...
class BasePhotoProof extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('taskid, siteProblemId, clickedBy, type', 'numerical', 'integerOnly'=>true),
			...
			array('id, taskid, imageName, clickedDateTime, clickedLat, clickedLng, siteProblemId, clickedBy, createdDate, modifiedDate, installation, lighting, obstruction, comments, type', 'safe', 'on'=>'search'),
		);
	}
