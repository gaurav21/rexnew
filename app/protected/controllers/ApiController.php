        ...
        switch ($_GET['model']) {
            ...
            case 'tasks':
                ...
                if ($user === null) {
                    ...
                    if ($tDone == 1) {
                        $sql = "SELECT t.id, t.clientName AS campaign, c.name as sitename, COUNT( pp.id ) as photocount, dueDate as duedate "
                                . "FROM Task t "
                        ...
                        $sql = "SELECT t.id, t.clientName AS campaign, c.name as sitename,  COUNT( pp.id ) as photocount, dueDate as duedate "
                                ...
                                . "inner join city c on c.id = t.inspectionLocationId "
                                . "LEFT JOIN PhotoProof pp ON pp.taskid = t.id "
                            . "WHERE t.status=1 AND t.taskDone=0 AND t.assigneduserid='$uId' "
